...
// ИСПРАВЛЕННАЯ функция plural - добавлены недостающие закрывающие скобки
function plural($n, $root, $suffixes) { 
    return $root . ($n % 10 == 1 && $n % 100 != 11 ? $suffixes[0] : (in_array($n % 10, [2, 3, 4]) && ($n % 100 < 10 || $n % 100 >= 20) ? $suffixes[1] : $suffixes[2])); 
}
...
<div class="row row-cols-1 row-cols-md-3 mb-4 g-4">
  <div class="col"><div class="card text-bg-light"><div class="card-body">
    ...
    <div class="display-6"><?php echo $count_equipment; ?></div>
  </div></div></div>
  <div class="col"><div class="card text-bg-light"><div class="card-body">
    <div class="h5">ПО:</div>
    <div class="display-6"><?php echo $count_software; ?></div>
  </div></div></div>
  <div class="col"><div class="card text-bg-light"><div class="card-body">
    <div class="h5">Лицензии:</div>
    <div class="display-6"><?php echo $count_licenses; ?></div>
  </div></div></div>
  <div class="col"><div class="card text-bg-warning"><div class="card-body">
    <div class="h5">Лицензий истекает:</div>
    <div class="display-6"><?php echo $count_expiring; ?></div>
  </div></div></div>
  <div class="col"><div class="card text-bg-danger"><div class="card-body">
    <div class="h5">Лицензий просрочено:</div>
    <div class="display-6"><?php echo $count_expired; ?></div>
  </div></div></div>
</div>
